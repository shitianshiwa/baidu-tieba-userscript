...
# 修改
* 无用户名的贴吧账号无法正常运行此脚本（2019-12-14作者已修复这个问题！https://github.com/FirefoxBar/userscript/issues/20）
* 修改为只在各个贴吧的主页和主题贴里运行
...
* 修改了屏蔽显示样式，已避免特殊情况下，导致楼层错位（'position: absolute;'改为'position: relative;''）,加深了屏蔽颜色
