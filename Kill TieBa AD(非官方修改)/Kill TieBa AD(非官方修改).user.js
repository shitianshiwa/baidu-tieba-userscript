...
(function() {
    ...
    function killad() {
        try {
            ...
            easyADs = document.querySelectorAll("div#branding_ads"); //2019-11-1发现的广告 <div id="branding_ads">
            if (easyADs[0] != null) {
                easyADs[0].style = "display:none;";
            }
        } catch (error) {
        ...
        {
            var threadList = document.querySelector(a + ">" + a),
                i;
                ...
                if (thread.tagName == "STYLE") {
                    ...
                    if (thread.getAttribute && thread.getAttribute("data-field")) {
                        ...
                        let tdata = JSON.parse(thread.getAttribute("data-field")),
                            pContent = thread.querySelector(".p_content_fix");
